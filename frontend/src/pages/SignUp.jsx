      ...
      <div className="flex overflow-hidden items-center w-screen justify-center flex-col h-screen bg-[#F0F0F0]">
        <div className="flex w-full items-center">
          <div className="left w-[30%] flex flex-col ml-[100px]">
            ...
            <img className='w-[210px] ' src={logo_trans} alt="" /> 
            {/* <h1 className="text-">DocFlex</h1> */}
            <form onSubmit={createUser} className='pl-3 mt-[-28px]' action="">
              ...
              <button className='p-[10px] bg-green-500 transition-all hover:bg-green-600 text-white rounded-lg w-full border-0 mt-3 mb-5'>Sing Up</button>
